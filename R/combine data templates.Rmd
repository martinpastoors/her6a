...
bio <- 
  ...
  mutate(vessel = gsub("\\s+", "", str_trim(toupper(vessel))),
         ...
         mat    = ifelse(!is.na(maturitystage14), maturitystage14, mat),
...
```{r, echo=FALSE, fig.align="center", fig.asp=1, fig.width=10, message=FALSE, warning=FALSE}
